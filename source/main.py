# _____________________Prepare maps______________________
# Incase you don't have any maps, uncomment below lines.
# It will create maps as .txt files
# But if you have already had "test" folder, you are good to skip this.
...
#    test2.draw_footprint()     #Maps with footprint (to see how it works)
    test2.draw_map()
...
#    test3.draw_footprint()     #Maps with footprint
    test3.draw_map()
